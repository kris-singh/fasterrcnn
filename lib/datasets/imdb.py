...
class imdb(object):
    ...
    def append_flipped_images(self):
        ...
        for i in range(num_images):
            ...
            entry = {'boxes': boxes, 'gt_overlaps': self.roidb[i]['gt_overlaps'],
                     'gt_classes': self.roidb[i]['gt_classes'], 'flipped': True}
    ...
    def create_roidb_from_box_list(self, box_list, gt_roidb):
        ...
        for i in range(self.num_images):
            ...
            roidb.append({'boxes': boxes, 'gt_classes': np.zeros((num_boxes,), dtype=np.int32), 'gt_overlaps': overlaps,
                'flipped': False, 'seg_areas': np.zeros((num_boxes,), dtype=np.float32), })
        return roidb
